...
bool good(double x){
    int s=0;
    for(int i=0;i<n;i++){
        s+=floor(a[i]/x);     //either a[i] and x should be double  in order for the floor function to work so the vecter 'a could be of double or int both cause x is double.
    }
